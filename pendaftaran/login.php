        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6 " action="login.php" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="id_login" name="id" type="text" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-200 sm:text-sm p-2 pe-12 text-sm sm:leading-6">
                    </div>
                </div>
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                Belum mendaftar?
                <a href="index.php" class="font-semibold leading-6 text-blue-600 hover:text-blue-500">Daftar disini</a>
                atau 
